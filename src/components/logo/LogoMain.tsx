...
export default function LogoMain({ reverse = false }: LogoMainProps) {
    ...
    <>
      <svg width="118" height="35" viewBox="0 0 118 35" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill={reverse ? theme.palette.common.white : theme.palette.primary.dark}
        />
        <path
        ...
        <path
          ...
          fill={reverse ? theme.palette.common.white : theme.palette.primary.main}
        />
        <path
          ...
          fill={reverse ? theme.palette.common.white : theme.palette.common.black}
          fillOpacity="0.85"
        />
        <defs>
          <linearGradient id="paint0_linear" x1="8.62526" y1="14.0888" x2="5.56709" y2="17.1469" gradientUnits="userSpaceOnUse">
            <stop stopColor={reverse ? theme.palette.common.white : theme.palette.primary.dark} />
            <stop offset="0.9637" stopColor={reverse ? theme.palette.common.white : theme.palette.primary.dark} stopOpacity="0" />
          </linearGradient>
          <linearGradient id="paint1_linear" x1="26.2675" y1="14.1279" x2="28.7404" y2="16.938" gradientUnits="userSpaceOnUse">
            <stop stopColor={reverse ? theme.palette.common.white : theme.palette.primary.dark} />
            <stop offset="1" stopColor={reverse ? theme.palette.common.white : theme.palette.primary.dark} stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
    </>
